---
title: "Explicación de las funciones para el pegado de la GEIH"
...
**Nota**: Para utilizar las funciones y unir las bases de datos no es necesario saber R, el archivo README.md (ubicado en la capeta raíz del repositorio) está creado con el fin de ser lo más explícito posible para que puedas utilizarlas sin inconvenientes, sin embargo, para entender como funciona la lógica detrás del pegado de las bases de datos es necesario entender como funciona R. En este espacio explicaremos linea a linea como están construidas estás funciones.

## *Función para el pegado de todos los modulos en un mes determinado (merge_month)*
...
### 3. Definir las variables a eliminar
...
### 5. Listar los archivos CSV en el directorio
...
### 7. Fusión de los archivos restantes
...
### 8. Eliminar columnas duplicadas
...
### 9. Devolver el data.table final
...
## *Función para el pegado de todos los meses (`geih_completed`)*
...
### 3. Listar los subdirectorios (meses)
...
### 4. Inicializar un `data.table` vacío
...
### 6. Combinar datos para cada mes
...
### 7. Devolver el `data.table` combinado
