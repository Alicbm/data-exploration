...
## 5. Funcion para la validación de contenido `select_suffix()`
...
## 6. Funcion para la validación de contenido `content_alidation()`
...
Esta línea define una nueva función llamada `content_alidation()` La función toma cuatro argumentos:
...
```{r eval = FALSE}
content_alidation(data, "marzo", "DPTO", c("OCI", "P7360", "P9460"))
```
